...
const DataCell: React.FC<DataCellProps> = ({ selectedCell, onClose }) => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full fade-in">
      <div className="flex items-center justify-between py-2 border-b border-foreground_alt/30">
        <div className="flex items-center gap-2">
          <span className="text-sm font-semibold text-primary">Data Details</span>
          <Badge
            variant="outline"
            className="border-foreground_alt/30 text-xs text-primary/60"
          >
        ...
        {onClose && (
          <Button
            variant="ghost"
            size="sm"
            className="h-7 px-2 text-primary/60 hover:text-primary hover:bg-foreground_alt"
            onClick={onClose}
          >
      ...
      <div className="grid grid-cols-1 gap-1">
        {Object.entries(selectedCell).map(([key, value]) => {
          ...
          return (
            <Card key={key} className="border border-foreground_alt/20 bg-foreground/50 rounded-lg">
