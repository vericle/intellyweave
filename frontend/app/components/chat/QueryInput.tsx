...
import { PiScales, PiMagnifyingGlass, PiTreeStructure, PiArrowCircleUp, PiX, PiGear, PiCircle, PiTrash } from "react-icons/pi";
              ...
              <Tooltip>
                ...
                <TooltipContent side="top" className="max-w-xs">
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-semibold text-accent">BETA</span>
                      <span className="text-xs font-medium">Intelligence Mode</span>
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Multi-agent intelligence analysis for relationship exploration and pattern detection (3-5 mins)
                    </p>
                  </div>
                </TooltipContent>
              </Tooltip>
