...
To use Elysia with Weaviate, i.e. for agentic searching and retrieval, you need to either have a _locally running_ instance of Weaviate, or access to a _Weaviate cloud cluster_ via an api key and URL. This can be specific in the app directly (see above image), or by creating a `.env` file with
