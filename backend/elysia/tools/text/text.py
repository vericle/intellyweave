...
class FakeTextResponse(Tool):
    def __init__(self, **kwargs):
        super().__init__(
            name="text_response",
            description="""
            Provide intelligence analysis summary with entity relationships identified.
            End conversation with analytical findings highlighting key persons, organizations, and locations found.
            Suggest follow-up queries like 'Map locations mentioned' or 'Show person networks' when entities are present.
            Use this to answer conversational questions not related to other tools. But do not use this as a source of information.
