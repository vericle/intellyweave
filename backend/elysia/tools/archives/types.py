...
NAMING CONVENTIONS:
- score: 0.0-1.0 relevance/quality score 
- reasoning: explanation for score 
- snippet: short preview text
- title: document title
- name: source/archive name (distinct from title)
"""
...
def truncate(text: str, max_length: int = 200, suffix: str = "...") -> str:
    ...
    Standard truncation helper to ensure consistent behavior across codebase.
    ...
    Returns:
        Truncated text with suffix if exceeded max_length, original otherwise
    """
...
class ArchiveSource:
    ...
    score: float = 0.0  # 0.0-1.0, LLM-assigned relevance score
    reasoning: str = ""  # Why this source is relevant
...
class Evidence:
    ...
    source_id: str
    content: str
    score: float = 0.0  # 0.0-1.0 relevance score
