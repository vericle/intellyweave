    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            name="aggregate",
            description="""
            Count and analyze entity distributions for intelligence patterns.
            Use to find: most mentioned persons, organization frequency by location, event timeline patterns.
            Calculates entity relevance (mention frequency) to identify key players and operational hotspots.
            Groups data by entity types (persons, organizations, locations) and applies filters directly.
            Perfect for identifying intelligence patterns, key entities, and geographic concentrations.
            This can be applied directly on any collections in the schema.
            'aggregate' should be considered the first choice for counting entity mentions, location frequencies,
            or temporal patterns, even when filtering is required.
            """,
            status="Aggregating...",
            inputs={
                "collection_names": {
