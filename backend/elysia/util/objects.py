...
class Tracker:
    ...
    def update_lm_costs(self, lm: "dspy.LM | GPT5ResponsesClient | None" = None, model_type: str = "base_lm"):
    ...
    def end_tracking(
        ...
        tracker_name: str,
        call_name: str = "",
        base_lm: "dspy.LM | GPT5ResponsesClient | None" = None,
        complex_lm: "dspy.LM | GPT5ResponsesClient | None" = None,
    ):
