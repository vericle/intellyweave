...
async def _evaluate_field_statistics(
    ...
    if not out["type"].startswith("object") and properties[property] != "geoCoordinates":
...
async def preprocess_async(
    ...
    if client_manager is None:
        # Use settings parameter to let ClientManager detect connection type
        # (local, cloud, or custom) from environment configuration
            ...
            if await client.collections.exists("ELYSIA_METADATA__"):
                ...
                metadata_collection = await client.collections.create(
                    ...
                    inverted_index_config=Configure.inverted_index(
                        ...
                        index_property_length=True  # Also useful for filtering by array length
                    ),
                )
