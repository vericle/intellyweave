...
class TreeManager:
    ...
    async def process_tree(
        ...
        Args:
            ...
            is_courthouse_mode (bool): Optional. Whether to enable courthouse debate mode for this query.
                Defaults to False.
            is_intelligence_mode (bool): Optional. Whether to enable intelligence analysis mode for this query.
                Defaults to False.
        """
        ...
        try:
            async for yielded_result in tree.async_run(
                ...
                is_courthouse_mode=is_courthouse_mode,
                is_intelligence_mode=is_intelligence_mode,
            ):
