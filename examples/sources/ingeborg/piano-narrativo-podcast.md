# Piano Narrativo: "Il Caso Ingeborg - Un'Indagine tra Guerra Fredda e Intelligenza Artificiale"

## Concept

**Serie podcast audio stile "Blu Notte"** che intreccia tre timeline parallele usando le tecniche narrative di Carlo Lucarelli (montaggio parallelo, freeze frame, flashback digressivi, climax asciutti).

### Le Tre Timeline

1. **Vienna dopoguerra**: La storia umana - spionaggio, relazioni pericolose, fughe, identità multiple
2. **Investigazione moderna**: La ricerca sui documenti, gli archivi, le scoperte, le incongruenze
3. **Evoluzione tecnologica**: Da strumenti inadeguati a piattaforma di intelligence avanzata

### Pubblico Target

Multi-layer appeal:
- **Appassionati storia/spionaggio**: Misteri della Guerra Fredda, agenti segreti, casi irrisolti
- **Professionisti tech/AI**: Entity extraction, NLP, vector databases, intelligence analysis
- **Pubblico generale**: Storia ben raccontata con suspense e colpi di scena
...
**Focus Narrativo**: Introduzione al mistero centrale

**Timeline Primaria**: Storia umana (arresto del personaggio principale)
...
- Climax: La domanda fondamentale che innesca tutta l'indagine

**Domande per l'Utente**:
- Quale aspetto enfatizzare: suspense del mistero o dettaglio storico?
- Quanto spazio dare alla spiegazione del contesto Guerra Fredda?

---

### EPISODIO 2: "Il Problema delle Lettere Mute"

**Focus Narrativo**: L'ostacolo tecnologico che blocca l'indagine

**Timeline Primaria**: Investigazione moderna (impossibilità di leggere documenti chiave)
...
- Climax: La scoperta dello strumento che risolve il problema

**Domande per l'Utente**:
- Quanto approfondire gli aspetti tecnici di NLP e entity extraction?
- Il pubblico target ha familiarità con concetti di machine learning?
...
**Timeline Primaria**: Storia umana (detenzione e liberazione del padre)
...
- Digressione: Il CIC, L'organizzazione che liberò il padre e il suo probabile ruolo nel dopoguerra. I documenti trovati nel database dell'Arolsen Archive e processatiu con l'AI
- Climax: La connessione sospetta tra liberazione del padre e reclutamento della figlia


**Domande per l'Utente**:
- Di quale gruppo partigiano potrebbe far parte il padre?
- Quanto enfatizzare la sofferenza nei campi vs il focus sull'intelligence?
- Esplicitare l'ipotesi di reclutamento o lasciare implicito?
...
**Focus Narrativo**: La relazione centrale e i primi eventi sospetti

**Timeline Primaria**: Storia umana (relazione, nascondimento, arresto)

**Timeline Secondaria**: Investigazione (analisi delle incongruenze nella versione ufficiale)
...
- Climax: L'evasione impossibile

**Domande per l'Utente**:
- Enfatizzare aspetto romantico o aspetto intelligence operation?
- Quanto esplicitare i sospetti sull'evasione?
...
**Timeline Primaria**: Investigazione (inventario di certezze e incertezze)
...
- Digressione: Le limitazioni epistemologiche dell'AI
- Climax: L'indagine continua, gli strumenti esistono, i documenti forse esistono

**Fonti da Analizzare**:
- Investigation report (sezione documenti necessari ma irraggiungibili)
