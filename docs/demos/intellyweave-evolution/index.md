...
- **Archive research** with hypothesis-driven investigation (Quartermaster + Case Officer)
...
- Archive research (Quartermaster discovery + Case Officer investigation)
...
*This demo documents the evolution of IntellyWeave as a platform.*
