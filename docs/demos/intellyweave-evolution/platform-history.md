...
| Archive Research | None | Quartermaster + Case Officer |
...
flowchart TB
    ...
    subgraph IW["2025: INTELLYWEAVE"]
        ...
        I5["6-phase intelligence orchestrator"]
        I6["Mapbox 3D + vis-network"]
        I7["✅ Production-ready platform"]
    end
...
- [Archive Research Guide](../../guides/archive-research/) - Quartermaster + Case Officer
