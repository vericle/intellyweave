...
flowchart TB
    ...
    subgraph IntellyWeave["INTELLYWEAVE<br/>Intelligence Platform"]
        ...
        I4["• Archive research (Quartermaster + Case Officer)"]
        I5["• 6-phase intelligence analysis orchestrator"]
        I6["• Intelligence-specific agent roles"]
    end
...
- **Archive research** via Quartermaster (discovery) + Case Officer (investigation)
...
Two-agent investigative system for external archive discovery:
- **Quartermaster** maps the information landscape (30+ curated archives)
- **Case Officer** conducts hypothesis-driven investigation
- Access level classification (Public, Subscription, Physical-Only, Restricted)
- Step-by-step access instructions for restricted sources
- Evidence-backed hypothesis testing with confidence scoring

> For archive research features, see [Archive Research Guide](../../guides/archive-research/).
...
- [Archive Research](../../guides/archive-research/) - Quartermaster + Case Officer
